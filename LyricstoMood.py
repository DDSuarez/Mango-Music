...
# Needs to return a concatnated string of lyrics, search is not too efficient, needs to be made efficient
def lyrics(search):
    url = "https://api.cognitive.microsoft.com/bing/v5.0/news/search?q=" + search + "&count=10&offset=0&mkt=en-us&safeSearch=Moderate"
    header = {'Host': 'api.cognitive.microsoft.com', 'Ocp-Apim-Subscription-Key': 'a7c37c0e2b124cfe8e74f4824693d0f6'}
